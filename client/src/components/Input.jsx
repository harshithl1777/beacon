...
const Input = (props) => {
  ...
  const getIcon = () => {
    const iconClassName = children
      ? styles.inputIcon
      : styles.inputIconNoPlaceholder;
    if (variant === "warning")
      return (
        <Icon className={iconClassName} name="IoAlertCircle" color="yellow" />
      );
    else if (variant === "error")
      return (
        <Icon className={iconClassName} name="IoCloseCircle" color="red" />
      );
    else if (variant === "success")
      return (
        <Icon
          className={iconClassName}
          name="IoCheckmarkCircle"
          color="green"
        />
      );
    return null;
