    ...
    return auth.isLoggedIn ? (
        ...
        <div className={styles.formWrapper} onSubmit={(e) => credentialsSignUp(e)}>
            <form className={styles.form}>
                ...
                <Input wrapperClass={styles.formInput} type='password' value={confirmedPassword} onChange={setConfirmedPassword}>
                    Confirm password
                </Input>
                <Button onClick={(e) => credentialsSignUp(e)} type='submit' wrapperClass={styles.formSubmit}>
                    Sign up for Beacon
                </Button>
